                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{asset('template/dist/img/avatar5.png')}}" class="img-rounded"
                                     alt="User Image">
                                <p>
                                    @if(Auth::check())
                                        {{Auth::user()->name}}
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <center>
                    <img src="{{asset('template/dist/img/Logo-Amdepo-2.gif')}}" width="150" height="150" class="img-rounded" alt="User Image">
                </center>
            </div>
