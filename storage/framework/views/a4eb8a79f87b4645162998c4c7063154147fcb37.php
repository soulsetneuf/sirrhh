        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
            	...
            	<div class="panel-body">
            		...
            		<?php echo Form::open(['route' => 'planillas_de_asistencia.report', 'method' => 'GET']); ?>
					...
					<?php echo Form::close(); ?>
						...
						<script type="text/javascript">
						    ...
						    yAxis: {
						        min: 0,
						        title: {
						            text: 'Total personas en planilla (Cantidad)'
						        }
						    },
						    tooltip: {
						        headerFormat: '<span style="font-size:10px">{point.key}</span><table>',
						        pointFormat: '<tr><td style="color:{series.color};padding:0">{series.name}: </td>' +
						            '<td style="padding:0"><b>{point.y:.1f} Total personas</b></td></tr>',
						        footerFormat: '</table>',
						        shared: true,
						        useHTML: true
						    },
